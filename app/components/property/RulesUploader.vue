  ...
  <div class="p-1 md:p-4 max-w-4xl mx-auto">
    ...
    <div class=" rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden mb-6">
      ...
      <div class="p-1 md:p-4">
        ...
        <div v-else class="space-y-4">
          <div v-for="(rule, index) in activeRules" :key="rule.id"
            ...
            <div
              class="px-4 py-3 border-b border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 rounded-t-lg">
              <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                  <!-- Rule Number -->
                  <div class="rule-number">
                    <button @click="toggleEdit(rule.id)"
                  ...
                  <div class="flex-1 min-w-0">
                    <div v-if="editingRuleId === rule.id" class="flex items-center gap-2">
                      <input v-model="rule.title" @input="markUnsaved"
                ...
                <div class="flex items-center gap-2">
                  <button @click="toggleMandatory(rule.id)" :class="[
            ...
            <div class="p-4">
              ...
              <div v-if="editingRuleId === rule.id" class="mb-4">
                ...
                <UEditor v-model="rule.description" :toolbar="[
                  ['bold', 'italic'],
            ...
            <!-- Rule Footer -->
            <div
              class="px-4 py-3 border-t border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 rounded-b-lg flex items-center justify-between text-xs">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      <div class="  rounded-lg p-4 border border-gray-200 dark:border-gray-700">
        ...
        <div class="space-y-2">
          <button v-for="template in quickTemplates" :key="template.title" @click="applyTemplate(template)"
            ...
            <div class="flex items-center justify-between">
              ...
              <span
                :class="['text-xs px-1.5 py-0.5 rounded', template.is_mandatory ? 'bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200' : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400']">
      ...
      <div class=" rounded-lg p-4 border border-gray-200 dark:border-gray-700">
        ...
        <div class="space-y-3">
          ...
          <div class="flex items-center justify-between">
            ...
            <span class="font-semibold text-gray-600 dark:text-gray-400">{{ activeRules.length - mandatoryCount
            }}</span>
          </div>
        </div>
      </div>
      ...
      <div class="max-w-4xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-3">
          <div class="flex items-center gap-2 text-amber-600 dark:text-amber-400">
            ...
            <span class="font-medium text-sm">Unsaved Changes</span>
          </div>
    ...
    <div v-if="showImportModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div class=" rounded-xl max-w-md w-full p-6">
        ...
        <div class="mb-4">
          <textarea v-model="importText" placeholder="Paste rules here (one per line):
1. No smoking [Required]
2. Check-in after 3 PM [Required]
3. Pets allowed [Optional]"
            class="w-full h-48 p-3 text-sm border border-gray-300 dark:border-gray-600 rounded-lg  focus:ring-2 focus:ring-blue-500"></textarea>
        </div>
        ...
        <div class="flex gap-3">
          ...
          <button @click="processImport" class="flex-1 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg">
            Import
          </button>
        </div>
      </div>
